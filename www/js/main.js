...
var _user$project$Main$header = function (model) {
	return _elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_debois$elm_mdl$Material_Options$cs('mdl-color--indigo-700')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
...
var _user$project$Main$defaultModel = {mdl: _debois$elm_mdl$Material$model, clicked: false};
var _user$project$Main$Model = F2(
	function (a, b) {
		return {mdl: a, clicked: b};
	});
var _user$project$Main$Unclicked = {ctor: 'Unclicked'};
var _user$project$Main$Clicked = {ctor: 'Clicked'};
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Click on the list icon at right ====>')
							]))
					])),
				A2(
				_debois$elm_mdl$Material_Grid$cell,
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_debois$elm_mdl$Material_Button$onClick(_user$project$Main$Unclicked)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_debois$elm_mdl$Material_Icon$i('list')
							]))
					]))
			])) : A2(
		_debois$elm_mdl$Material_Grid$grid,
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_debois$elm_mdl$Material_Button$icon,
								_debois$elm_mdl$Material_Button$onClick(_user$project$Main$Clicked),
								A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('TOOLTIP TEST')
							]))
					])),
				A2(
				_debois$elm_mdl$Material_Grid$cell,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('<==== Click on the add icon at left')
							]))
					]))
			]));
};
		...
		A4(
				...
				]),
			{
				...
				main: _elm_lang$core$Native_List.fromArray(
					[
						_debois$elm_mdl$Material_Options$stylesheet(''),
